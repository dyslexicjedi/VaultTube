...
| `VAULTTUBE_COMPOSITE_REACTION_GAIN_DB` | Reaction input gain before the final mix (default `+8` dB) |
| `VAULTTUBE_COMPOSITE_COMPANION_GAIN_DB` | Jellyfin input gain before the final mix (default `-5` dB) |
